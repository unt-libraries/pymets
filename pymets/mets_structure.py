...
class MetsBase(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.tag = getattr(self, 'tag', None) #set the element's tag to None if it isn't defined
        self.contained_children = getattr(self, 'contained_children', []) #list of allowed child elements
        self.allows_content = getattr(self, 'allows_content', False) #by default, objects don't have textual content
        self.atts = getattr(self, 'atts', {}) #attributes of this particular element
        self.content = None   #textual content, if any
        self.children = []    #child element wrappers go here
    ...
    def get_att(self, attName):
        """
        gets a single attribute, or none if it does not exist
        """
        if self.atts.has_key(attName):
...
class Mets(MetsBase):
    ...
    def create_xml_file(self, mets_filename, nsmap=None ):
        """Takes a filename and a mets python object and creates a mets file """
        try:
    ...
    def create_xml_string(self, nsmap=None):
        """Converts a mets elements list (list of MetsBase objects) 
            and returns a mets xml document in a string which you can output into a file:
...
class MetsHdr(MetsBase):
    ...
    def __init__(self, **kwargs):
        self.atts = { "RECORDSTATUS":None, "CREATEDATE":None, "LASTMODDATE":None, \
            "ID": None}
...
class File(MetsBase):
    ...
    def __init__(self, **kwargs):
        self.atts = { "ID":None, "MIMETYPE":None,  "USE":None, "CREATED":None, \
        "CHECKSUM":None, "CHECKSUMTYPE":None, "SIZE":None, "ADMID":None, \
        "OWNERID":None, }
...
class Div(MetsBase):
    ...
    def __init__(self, **kwargs):
        self.atts = { "DMDID":None, "TYPE":None, "ID":None, "ORDER":None, \
        "ORDERLABEL":None, "LABEL":None, "ADMID":None, "CONTENTIDS":None}
...
class Area(MetsBase):
    ...
    def __init__(self, **kwargs):
        self.atts = { "ID":None, "FILEID":None, "SHAPE":None, "COORDS":None, "BEGIN":None,\
        "END":None, "BETYPE":None, "EXTENT":None, "EXTYPE":None, "ADMID":None,\
        "CONTENT":None, "IDS":None}
...
class SmLink(MetsBase):
    ...
    def __init__(self, **kwargs):
        self.atts = { "ID":None, XLINK+"arcrole":None, XLINK+"title":None, XLINK+"actuate":None,\
        XLINK+"to":None, XLINK+"from":None}
...
class Behavior(MetsBase):
    ...
    def __init__(self, **kwargs):
        self.atts = { "ID":None, "STRUCTID":None, "BTYPE":None, "CREATED":None,\
        "LABEL":None, "GROUPID":None, "ADMID":None }
